...
import com.example.CONNECT.cache.AppCache;
import com.example.CONNECT.response.WeatherResponse;
...
//        String FINAL_API = API.replace("<api_key>",API_KEY).replace("<city>",city);
        ...
        if (weatherResponse != null){
            ...
            String FINAL_API = URL.replace("<api_key>", AppCache.APP_CACHE).replace("<city>",city);
